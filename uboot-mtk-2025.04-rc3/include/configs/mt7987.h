...
#if defined(GS7_MAGIC) || defined(RTBE59) // MT7992
#define CFG_UBI_FACTORY_NR_LEB		15	/* 124KB * 15 = 1860KB, eeprom occupy, MT7988:1392KB(0x15c000), MT7987:1394KB(0x15c800)  */
...
#else
#error Define your flash layout!
#endif
...
#else
#error Define your flash layout2!
#endif
...
#define CFG_DUAL_TRX
#undef ASUS_EXTRA_ENV_SETTINGS
#define ASUS_EXTRA_ENV_SETTINGS	"ethact=ethernet@15110200\0"
