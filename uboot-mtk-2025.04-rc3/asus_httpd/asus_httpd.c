...
static int do_asus_httpd(struct cmd_tbl *cmdtp, int flag, int argc,
		    char *const argv[])
{
	int ret;
...
U_BOOT_CMD(asus_httpd, 1, 0, do_asus_httpd,
	"Start ASUS HTTP server", ""
);
