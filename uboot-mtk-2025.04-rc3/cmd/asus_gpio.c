...
static struct gpio_s {
	...
	[MESH_B_LED] =		{	/* GPIO23, Low active, output */
		.name = "Mesh Blue LED",
		.gpio_nr = 23,
		.dir = 0,
		.is_led = 1,
	...
	[MESH_G_LED] =		{	/* GPIO24, Low active, output */
		.name = "Mesh Green LED",
		.gpio_nr = 24,
		.dir = 0,
		.is_led = 1,
	...
	[MESH_R_LED] =		{	/* GPIO25, Low active, output */
		.name = "Mesh Red LED",
		.gpio_nr = 25,
		.dir = 0,
		.is_led = 1,
...
#elif defined(EAGLE_A) || defined(EAGLE_D)
	[RST_BTN] =		{	/* GPIO 13, Low  active, input  */
		.name = "Reset button",
		.gpio_nr = 13,
		.dir = 1,
		.is_led = 0,
	...
	[WPS_BTN] =		{	/* GPIO 14, Low  active, input  */
		.name = "WPS button",
		.gpio_nr = 14,
		.dir = 1,
		.is_led = 0,
...
#elif defined(BT8) || defined(BT6) || defined(BT8P)
	[RST_BTN] =		{	/* GPIO 13, Low  active, input  */
		.name = "Reset button",
		.gpio_nr = 13,
		.dir = 1,
	...
	[WIFI_R_LED] =	{		/* GPIO 57, Hight active, output */
		.name = "Red LED",
		.gpio_nr = 57,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_G_LED] =	{		/* GPIO 21, Hight active, output */
		.name = "Green LED",
		.gpio_nr = 21,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_B_LED] =	{		/* GPIO 59, High active, output */
		.name = "Blue LED",
		.gpio_nr = 59,
		.dir = 0,
		.is_led = 1,
...
#elif defined(GS7) || defined(GSBE7200X)
	[RST_BTN] =		{	/* GPIO 13, Low  active, input  */
		.name = "Reset button",
		.gpio_nr = 13,
		.dir = 1,
	...
	[WIFI_R_LED] =	{		/* GPIO 59, Hight active, output */
		.name = "Red LED",
		.gpio_nr = 59,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_G_LED] =	{		/* GPIO 58, Hight active, output */
		.name = "Green LED",
		.gpio_nr = 58,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_B_LED] =	{		/* GPIO 60, High active, output */
		.name = "Blue LED",
		.gpio_nr = 60,
		.dir = 0,
		.is_led = 1,
	...
	[PWR_LED] = 		{	/* GPIO52, Low active, output, default on */
		.name = "Power LED",
		.gpio_nr = 52,
		.dir = 0,
		.is_led = 1,
	...
	[WAN_LED] = 		{	/* GPIO53, Low active, output */
		.name = "WAN LED",
		.gpio_nr = 53,
		.dir = 0,
		.is_led = 1,
	...
	[WAN_RED_LED] = 	{	/* GPIO54, Low active, output */
		.name = "WAN Red LED",
		.gpio_nr = 54,
		.dir = 0,
		.is_led = 1,
	...
	[LAN_LED] = 		{	/* GPIO50, Low active, output */
		.name = "LAN LED",
		.gpio_nr = 50,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_2G_LED] = 	{	/* GPIO51, Low active, output */
		.name = "WiFi LED",
		.gpio_nr = 51,
		.dir = 0,
		.is_led = 1,
...
#elif defined(EBA76)
	[RST_BTN] =		{	/* GPIO 1, Low  active, input  */
		.name = "Reset button",
		.gpio_nr = 1,
		.dir = 1,
		.is_led = 0,
	...
	[WIFI_R_LED] =	{		/* GPIO 24, low active, output */
		.name = "Red LED",
		.gpio_nr = 24,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_G_LED] =	{		/* GPIO 28, high active, output */
		.name = "Green LED",
		.gpio_nr = 28,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_B_LED] =	{		/* GPIO 30, low active, output */
		.name = "BLue LED",
		.gpio_nr = 30,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_W_LED] =	{		/* GPIO 29, low active, output */
		.name = "White LED",
		.gpio_nr = 29,
		.dir = 0,
		.is_led = 1,
...
#elif defined(GS7_MAGIC)
	[RST_BTN] =		{	/* GPIO 0, Low  active, input  */
		.name = "Reset button",
		.gpio_nr = 0,
		.dir = 1,
		.is_led = 0,
	...
	[WPS_BTN] =		{	/* GPIO 1, Low  active, input  */
		.name = "WPS button",
		.gpio_nr = 1,
		.dir = 1,
		.is_led = 0,
	...
	[WIFI_R_LED] =	{		/* GPIO 13, high active, output */
		.name = "Red LED",
		.gpio_nr = 13,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_G_LED] =	{		/* GPIO 43, high active, output */
		.name = "Green LED",
		.gpio_nr = 43,
		.dir = 0,
		.is_led = 1,
	...
	[WIFI_B_LED] =	{		/* GPIO 44, high active, output */
		.name = "BLue LED",
		.gpio_nr = 44,
		.dir = 0,
		.is_led = 1,
	...
	[PWR_LED] = {			/* GPIO 8, high active, output, default on */
		.name = "Power White LED",
		.gpio_nr = 8,
		.dir = 0,
		.is_led = 1,
		.active_low = 0,
	...
	[PWR_RED_LED] = {		/* GPIO 11, high active, output */
		.name = "Power Red LED",
		.gpio_nr = 11,
		.dir = 0,
		.is_led = 1,
	...
	[PWR_GREEN_LED] = {		/* GPIO 10, high active, output */
		.name = "Power Green LED",
		.gpio_nr = 10,
		.dir = 0,
		.is_led = 1,
		.active_low = 0,
	},
	[PWR_BLUE_LED] = {		/* GPIO 12, high active, output */
		.name = "Power Blue LED",
		.gpio_nr = 12,
		.dir = 0,
		.is_led = 1,
	...
	[WAN_LED] = 		{	/* GPIO5, high active, output */
		.name = "WAN LED",
		.gpio_nr = 5,
		.dir = 0,
		.is_led = 1,
	...
	[WAN_RED_LED] = 	{	/* GPIO6, high active, output */
		.name = "WAN Red LED",
		.gpio_nr = 6,
		.dir = 0,
		.is_led = 1,
	...
	[WPS_BTN] =		{	/* GPIO 0, Low  active, input  */
		.name = "WPS button",
		.gpio_nr = 0,
		.dir = 1,
		.is_led = 0,
	...
	[PWR_LED] = {			/* GPIO 49, high active, output, default on */
		.name = "Power White LED",
		.gpio_nr = 49,
		.dir = 0,
		.is_led = 1,
	...
	[WAN_LED] = 		{	/* GPIO10, low active, output */
		.name = "WAN LED",
		.gpio_nr = 10,
		.dir = 0,
		.is_led = 1,
	...
	[WAN_RED_LED] = 	{	/* GPIO11, low active, output */
		.name = "WAN Red LED",
		.gpio_nr = 11,
		.dir = 0,
		.is_led = 1,
	...
	[LAN_LED] = 		{	/* GPIO12 low active, output */
		.name = "LAN LED",
		.gpio_nr = 12,
		.dir = 0,
		.is_led = 1,
...
/* After uboot menu is displayed, initialize GPIO. */
static struct gpio_s gpio_tbl2[GPIO_IDX_MAX] = {
#if defined(GS7)
	[UART0_RX] = 		{	/* GPIO55, High active, output */
		.name = "Uart0 Rx",
		.gpio_nr = 55,
		.dir = 0,
		.is_led = 1,
	...
	for (i = 0; i < GPIO_IDX_MAX; i++) {
		...
		if (gpio_tbl[i].dir) // input
			...
			if (gpio_tbl[i].is_led) {
				...
				if (i == WIFI_B_LED || i == WIFI_R_LED || i == WIFI_W_LED) // only turn on WIFI_G_LED
					on = 0;
#elif (defined(BT8) || defined(BT6) || defined(BT8P)) || defined(EBA76) // RGB LED
				on = 0; // don't turn on any LED here
#endif
...
#if !(defined(BT8) || defined(BT6) || defined(BT8P) || defined(GS7) || defined(GSBE7200X) || defined(EBA76) || defined(GS7_MAGIC)) // don't turn off any LED here
...
void asus_gpio_init2(void)
{
	int i;
	int on;

	printf("ASUS %s gpio/led init2\n", model);

	for (i = 0; i < GPIO_IDX_MAX; i++) {
		if (!gpio_tbl2[i].name)
			continue;
		if (gpio_request(gpio_tbl2[i].gpio_nr, "boot") != 0) {
			printf("Request gpio[%d] ERR!\n", gpio_tbl2[i].gpio_nr);
			continue;
		}
		if (gpio_tbl2[i].dir) // input
			set_gpio_dir(i, 1, 0); // init input
		else { // output
			if (gpio_tbl2[i].is_led) {
				on = 1;
				set_gpio_dir(i, 0, on ^ !!(gpio_tbl2[i].active_low)); // init led
			}
			else
				set_gpio_dir(i, 0, gpio_tbl2[i].def_onoff_highlow); // init output
		}
	}

	for (i = 0; i < GPIO_IDX_MAX; i++) {
		if (!gpio_tbl2[i].name || gpio_tbl2[i].dir)
			continue;
		led_onoff(i, gpio_tbl2[i].def_onoff_highlow);
	}
}
