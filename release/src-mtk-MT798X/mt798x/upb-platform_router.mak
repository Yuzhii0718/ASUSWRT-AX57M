...
#	$(call inst,$(S),$(D),source/lib/libmapd_interface_client.so)
	...
	$(call inst,$(S),$(D),source32/bs20)
	$(call inst,$(S),$(D),source32/mapd_cli)
#	$(call inst,$(S),$(D),source32/lib/libmapd_interface_client.so)
endif
...
lowmem:
	$(call inst,$(S),$(D),source/lowmem.ko)

libmapd:
	$(call inst,$(S),$(D),source/libmapd_interface_client.so)

datconf:
	$(call inst,$(S),$(D),source/kvcutil/libkvcutil.so)
