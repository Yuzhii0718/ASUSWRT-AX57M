...
#define	ISP_SIZE 0x10000 /* 64KB */
extern void glue_isp_create(char *, unsigned int, struct mtd_partition *);
#ifdef ISP_SIZE
static struct mtd_partition isp = {
	.name = "isp",
	.size = ISP_SIZE,
	.offset = 0,
...
#ifdef ISP_SIZE
	glue_isp_create("Factory", ISP_SIZE, &isp);
#endif
