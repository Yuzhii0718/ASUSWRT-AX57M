									...
									<table style="border-collapse:collapse;width:100%">
										<tbody>
											...
											<tr id='wtfast_3' style="display:none">
												...
												<td style="width:400px;height:120px;">
													<div class="gB_desc" style="font-size:16px;color:#949393;padding-left:10px; margin-top: 10px;"><#Game_WTFast_desc#></div>
													<div class="gB_desc" id="thirdparty_pp" style="font-size:16px;color:#949393;padding-left:10px; margin-top: 15px; margin-bottom: 10px;"></div>
												</td>
												<td>
