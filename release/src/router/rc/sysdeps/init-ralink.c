...
#if defined(RTCONFIG_MT798X)
	void replace_regspec_from_loclist(char *buf, int len);
	replace_regspec_from_loclist(dst, sizeof(buffer));
#endif
...
void init_syspara(void)
{
	...
	config_hwctl_led();
#if 0 //defined(TUFAX4200) || defined(TUFAX6000) // EEPROM runtime fix
...
#endif
#if defined(RTCONFIG_RALINK_MT7621) && defined (RTCONFIG_WLMODULE_MT7915D_AP)
// workaround, pppoe + ipv6 native ppp
